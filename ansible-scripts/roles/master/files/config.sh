...
sed -i s/MESOS_HOSTNAME=.*/MESOS_HOSTNAME=${hostname}/ ${work_dir}/docker-compose/master/mesos_master_env
...
sed -i s/MARATHON_HOSTNAME=.*/MARATHON_HOSTNAME=${hostname}/ ${work_dir}/docker-compose/master/marathon_env
